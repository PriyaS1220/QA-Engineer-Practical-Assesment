...
#	Candidate Name - Shunmuga Priya R
#	Tools and Frameworks Used - Google Sheets for manual testing , Selenium-java for automation testing , Postman for performance testing
